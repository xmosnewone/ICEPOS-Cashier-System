...
namespace ICE.POS.Service
{
    ...
    public abstract class SqlHelper
    {
        ...
        /// 获得前几行数据
        /// </summary>
        public DataSet GetList(int Top, string strWhere, string tableName, string filedOrder)
        {
        ...
        public static int ExecteNonQuery(SqlConnection conn, SqlTransaction tran, CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            //SqlCommand cmd = new SqlCommand();
            ////using (SqlConnection _conn =conn)
            ////{
            ////通过PrePareCommand方法将参数逐个加入到SqlCommand的参数集合中
